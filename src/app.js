...
const phanInAdminRoutes = require('./modules/phaninadmin/phaninadmin.routes');
const technicalRoutes = require('./modules/technical/technical.routes');
const hsktRoutes = require('./modules/hskt/hskt.routes');
...
app.use('/api/quan-tri-phan-in', phanInAdminRoutes);
app.use('/api/ready', technicalRoutes);
app.use('/api/hskt', hsktRoutes);
