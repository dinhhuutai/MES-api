...
async function layBarcodeTem(actorId = null) {
  ...
  for (let i = 1; i <= soLan; i += 1) {
    try {
      ...
      ghiLog('ERP_BARCODE_TEM', {
        thanhCong: true, idBanGhi: bc, maTem: bc, url: env.erp.barcodeTemUrl,
  ...
  ghiLog('ERP_BARCODE_TEM', {
    thanhCong: false, idBanGhi: '-', url: env.erp.barcodeTemUrl,
